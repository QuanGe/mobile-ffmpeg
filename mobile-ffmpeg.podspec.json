{
  ...
  "source": {
    "http": "https://github.com/congnd/mobile-ffmpeg/releases/download/v4.4/mobile-ffmpeg-full-gpl-4.4-ios-xcframework.zip"
  },
  "ios": {
    "frameworks": [
      "AudioToolbox",
    ...
    "vendored_frameworks": [
      ...
      "libogg.xcframework",
      "libopencore-amrnb.xcframework",
      "libpng.xcframework",
      "libsndfile.xcframework",
      "libtheora.xcframework",
      "libtheoradec.xcframework",
      "libtheoraenc.xcframework",
      "libvorbis.xcframework",
      "libvorbisenc.xcframework",
      "libvorbisfile.xcframework",
      "libvpx.xcframework",
      "libwebp.xcframework",
      "libwebpmux.xcframework",
      "libwebpdemux.xcframework",
      "libxml2.xcframework",
      "opus.xcframework",
      "shine.xcframework",
      "snappy.xcframework",
      ...
      "tiff.xcframework",
      "twolame.xcframework",
      "vo-amrwbenc.xcframework",
      "wavpack.xcframework",
      "libvidstab.xcframework",
      "x264.xcframework",
      "x265.xcframework",
